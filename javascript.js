...
// let x1 = prompt("enter the starting x cordinate");
// let y1 = prompt("enter the starting y cordinate");
// let x2 = prompt("enter the ending x cordinate");
// let y2 = prompt("enter the ending y cordinate");
...
// let x,y;
// let temp;
// for(let a=min;a<=max;a=a+1){
//     x=a;
//     y=(((y2-y1)/(x2-x1))(a-x1))+y1;
//     temp = document.createElement("div");
//     temp.style.backgroundColor = "black";
//     temp.style.width = "2px";temp.style.height = "2px";
//     temp.style.position = "absolute";
//     temp.style.left = `${x}px`;
//     temp.style.right = `${y}px`;
...
//     for(let j=0;j<200;j++){
//         temp = document.createElement("div");
//         temp.setAttribute("class","pixceldiv");
...
//         console.log(temp.style.top);
//         console.log(temp);
//     }
// }
// let pixceldiv = document.querySelectorAll(".pixceldiv");
// // console.log(pixceldiv);
...
//     console.log("pointer position is running");
//     let X = Math.floor(e.pageX);
//     let Y = Math.floor(e.pageY);
//     pixceldiv[Y*200+X].style.backgroundColor = "red";
// }
...
// })
// document.body.addEventListener("pointermove",e=>{
//     let dot = document.getElementById(e.pointerId);
//     if(dot==null)return;
//     positionDot(e,dot);
//     console.log("vishal nagar");
...
//         temp.style.width = "10px";temp.style.height = "10px";
...
//     childdiv.style.left = e.offsetX;
//     childdiv.style.top = e.offsetY;
//     let dot = document.createElement("div");
//     dot.setAttribute("class","dot");
//     dot.id = e.pointerId;
//     positionDot(e,dot);
...
// })
// function positionDot(e,dot){
//     dot.style.width = `${e.width*50}px`;
//     dot.style.height = `${e.height*50}px`;
//     dot.style.left = `${e.pageX}px`;
//     dot.style.top = `${e.pageY}px`;
// }

// const div = document.querySelectorAll(".helping");
// console.log(div);
// console.log(div[0].offsetLeft);
